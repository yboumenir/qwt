...
/*!
  ...
  Needs to be overloaded from maps supporting QwtColorMap::Indexed
  colors. The default implementation returns always 0.
...
*/
unsigned char QwtColorMap::colorIndex( const QwtInterval &, double ) const
{
    return 0;
}
